...
import './Part.css'
import pic1 from '../../Asserts/rp2.jpg'
import pic2 from '../../Asserts/p1.png'
import pic3 from '../../Asserts/p2.jpg'
import pic4 from '../../Asserts/p3.jpg'
...
function Part() {
  ...
  return (
    <div className='main_container'>
      ...
      <div className='main'>
        <Section head={head1} body={body1} btn={btn1} img={pic1} check={noCheck} /><br/>
        <Section head={head2} body={body2} btn={btn2} img={pic2} check={noCheck} /><br/>
        <Section head={head3} body={body3} btn={btn3} img={pic3} check={noCheck} /><br/>
